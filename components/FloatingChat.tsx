    ...
    try {
      const res = await fetch("/api/ai/ask", {
        ...
        body: JSON.stringify({
          question,
          content:
            "Riyan adalah seorang Web Developer yang fokus pada AI, Web3, dan SaaS seperti Form2WA dan MUNU.",
          language: "id",
        }),
      });
        ...
        <DialogContent
            ...
            <div className="flex flex-col h-full w-full bg-white rounded-md border">
                <div className="flex items-center justify-between px-4 py-3 border-b bg-muted rounded-t-lg">
                    <span className="font-medium text-sm">Chat with Riyan Assistant</span>
                </div>

                {/* ✅ ScrollArea height fixed */}
                ...
                <div className="space-y-2 flex flex-col">
                    ...
                    >
                        ...
                        <div
                        className={`text-sm px-4 py-2 rounded-md max-w-[70%] whitespace-pre-wrap ${
                          msg.from === "user"
